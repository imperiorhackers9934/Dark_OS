...
def main():
	...
	if lazymux.strip() == "1" or lazymux.strip() == "01":
		...
		elif vulnscan.strip() == "04" or vulnscan.strip() == "4": easyMap()
		elif vulnscan.strip() == "05" or vulnscan.strip() == "5": red_hawk()
		elif vulnscan.strip() == "06" or vulnscan.strip() == "6": dtect()
		elif vulnscan.strip() == "07" or vulnscan.strip() == "7": dsss()
		elif vulnscan.strip() == "08" or vulnscan.strip() == "8": sqliv()
		elif vulnscan.strip() == "09" or vulnscan.strip() == "9": sqlmap()
		elif vulnscan.strip() == "10": sqlscan()
		elif vulnscan.strip() == "11": wordpreSScan()
		elif vulnscan.strip() == "12": wpscan()
		elif vulnscan.strip() == "13": sqlmate()
		elif vulnscan.strip() == "14": wordpresscan()
		elif vulnscan.strip() == "15": justforfun()
		elif vulnscan.strip() == "16": rang3r()
		elif vulnscan.strip() == "17": striker()
		elif vulnscan.strip() == "18": routersploit()
		elif vulnscan.strip() == "19": xshell()
		elif vulnscan.strip() == "20": sh33ll()
		elif vulnscan.strip() == "21": blackbox()
		...
		elif stresstest.strip() == "07" or stresstest.strip() == "7": hydra()
		elif stresstest.strip() == "08" or stresstest.strip() == "8": black_hydra()
		elif stresstest.strip() == "09" or stresstest.strip() == "9": xshell()
		...
		elif passtak.strip() == "12": social()
		elif passtak.strip() == "13": blackbox()
		elif passtak.strip() == "14": hashzer()
		...
		elif webhack.strip() == "05" or webhack.strip() == "5": wpsploit()
		...
		elif webhack.strip() == "09" or webhack.strip() == "9": sqlokmed()
		elif webhack.strip() == "10": zones()
		...
		elif webhack.strip() == "22": hpb()
		elif webhack.strip() == "23": inther()
		...
		elif exploitool.strip() == "05" or exploitool.strip() == "5": a_rat()
		elif exploitool.strip() == "06" or exploitool.strip() == "6": wpsploit()
		...
		elif exploitool.strip() == "10": xattacker()
		elif exploitool.strip() == "11": txtool()
		elif exploitool.strip() == "12": msfpg()
		...
		elif sspoof.strip() == "04" or sspoof.strip() == "4": spammer_email()
		...
		elif moretool.strip() == "04" or moretool.strip() == "4": ubuntu()
		elif moretool.strip() == "05" or moretool.strip() == "5": fedora()
		elif moretool.strip() == "06" or moretool.strip() == "6": nethunter()
		...
		elif moretool.strip() == "13": webconn()
		elif moretool.strip() == "14": crunch()
		elif moretool.strip() == "15": textr()
		elif moretool.strip() == "16": autovisitor()
		elif moretool.strip() == "17": rshell()
		elif moretool.strip() == "18": termpyter()
		elif moretool.strip() == "19": jadx()
		elif moretool.strip() == "20": f4k3()
		elif moretool.strip() == "21": heroku()
